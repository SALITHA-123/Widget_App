...
import 'package:first_app/MultiChild/Flow.dart';
import 'package:first_app/MultiChild/IndexStack.dart';
import 'package:first_app/MultiChild/Stack.dart';
import 'package:first_app/MultiChild/Wrap.dart';
                  ...
                  children: [
                    Expanded(flex: 1,
                      child: GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => FlowWid()));
                        },
                        child: Container(
                ...
                Row(
                  children: [
                    Expanded(flex: 1,
                      child: GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => InStack()));
                        },
                        child: Container(
                            margin: EdgeInsets.all(12),
                            alignment: Alignment(-1,0),
