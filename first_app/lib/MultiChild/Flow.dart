...
class FlowWid extends StatefulWidget {

  @override
  _FlowWidState createState() => _FlowWidState();
}

class _FlowWidState extends State<FlowWid> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Flow', style: TextStyle(fontSize: 30,),),
        centerTitle: true,
